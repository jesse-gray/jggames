...
class Checkout extends Controller
{
    ...
    public function index()
    {
        ...
        $data = ['products' => $products, 'street_number' => '', 'street_name' => '', 'suburb' => '', 'city' => '', 'postcode' => '', ];
    ...
    public function placeOrder()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST')
        {
            ...
            $data = ['street_number' => trim($_POST['inputStreetNumber']) , 'street_name' => trim($_POST['inputStreetName']) , 'suburb' => trim($_POST['inputSuburb']) , 'city' => trim($_POST['inputCity']) , 'postcode' => trim($_POST['inputPostcode']) , 'street_number_err' => '', 'street_name_err' => '', 'city_err' => '', 'region_err' => '', 'postcode_err' => ''];
            ...
            {
                // Validated
                $newAddress = ['street_number' => $data['street_number'], 'street_name' => $data['street_name'], 'suburb' => $data['suburb'], 'city' => $data['city'], 'region' => $data['region'], 'postcode' => $data['postcode']];
        ...
        {
            $data = ['street_number' => '', 'street_name' => '', 'suburb' => '', 'city' => '', 'region' => '', 'postcode' => ''];
