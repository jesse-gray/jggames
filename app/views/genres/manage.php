  ...
  <div>
      ...
      <tbody>
        ...
        <?php foreach ($data['genres'] as $genre): ?>
          <tr>
            <td scope="row"><?php echo $genre->name ?></td>
            <td class="pull-right">            
            ...
            <td class="pull-right">
              <a href="<?php echo URLROOT; ?>/genres/edit/<?php echo $genre->id; ?>" class="btn btn-primary ">Edit</a>              
            </td>            
          </tr>
        <?php endforeach; ?>        
      </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="confirm_delete_label">Confirm Delete Genre</h5>
        ...
        <div class="modal-footer">
            ...
            <form class="pull-right" action="<?php echo URLROOT; ?>/genres/delete/<?php echo $genre->id; ?>" method="post">
