<?php
  class Address {
    ...
    public function updateAddress($data){
      $this->db->query('UPDATE address SET street_number = :street_number, street_name = :street_name, suburb = :suburb, city = :city, region = :region, postcode = :postcode WHERE id = :id');
      // Bind values
      $this->db->bind(':street_number', $data['street_number']);
      $this->db->bind(':street_name', $data['street_name']);
      $this->db->bind(':suburb', $data['suburb']);
